...
export function level2(): LevelDef {
  const cues: Cue[] = [
    ...row(1200, () => E.grunt({ hp: 4 }), 6, L, R, 150),
    ...burst(3500, E.weaver, [L + 20, MID, R - 20]),
    ...row(5500, () => E.grunt({ hp: 4 }), 6, R, L, 130),
    ...
    ...row(53000, () => E.grunt({ hp: 5 }), 9, R, L, 90),
