...
/** Level 3 — maximum pressure: layered formations, frequent divers + spirals. */
export function level3(): LevelDef {
  const cues: Cue[] = [
    ...row(1000, () => E.grunt({ hp: 5 }), 8, L, R, 110),
    ...
    ...row(13000, () => E.grunt({ hp: 6 }), 9, L, R, 90),
    ...burst(16000, () => E.turret({ hp: 14 }), [110, 240, 370]),
    ...row(18000, E.weaver, 8, L, R, 110),

    ...burst(21500, () => E.diver(), [90, 170, 250, 330, 410]),
    ...burst(24000, E.carrier, [120, 360]),
    ...row(25500, () => E.grunt({ hp: 6 }), 10, R, L, 80),
    ...
    ...row(40000, () => E.grunt({ hp: 6 }), 11, L, R, 75),

    ...burst(44000, E.carrier, [110, 240, 370]),
    ...row(46000, E.weaver, 9, R, L, 95),
    ...burst(49500, () => E.turret({ hp: 14 }), [110, 240, 370]),

    ...burst(53000, () => E.diver(), [70, 150, 230, 310, 390]),
    ...row(55000, () => E.grunt({ hp: 7 }), 11, L, R, 70),
    ...
    // Pre-boss onslaught.
    ...row(71000, () => E.grunt({ hp: 7 }), 12, R, L, 65),
    ...burst(74500, () => E.turret({ hp: 14 }), [90, 240, 390]),
